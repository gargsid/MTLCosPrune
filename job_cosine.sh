...
python main.py --pruning=True --batch-size=16 --lr=0.00005 \
...
--epochs=500 --logs_dir=assets/experiments/taylor_pruning/mt_base_vgg_nyu/cosine_ranking_imagenet_pretrained/run_4 \
--cosine_ranking \
--num_workers=3 --pruning_config=./configs/MTLNet_nyu.json 

# python main.py --pruning=True --batch-size=16 --lr=0.00005 \
# --lr-decay-every=10 --momentum=0.9 --seed=0 --mgpu=False --group_wd_coeff=1e-8 --wd=0.0 --tensorboard=False --pruning-method=22 --no_grad_clip=True \
# --epochs=500 --logs_dir=assets/experiments/taylor_pruning/mt_base_vgg_nyu/cosine_ranking/run_6 \
# --cosine_ranking \
# --num_workers=4 --pruning_config=./configs/MTLNet_nyu.json 
# --num_workers=3 --pruning_config=./configs/test_config.json --testing
# --cosine_sampling \
